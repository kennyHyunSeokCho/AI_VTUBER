    ...
    const characterArea = useMemo(() => {
        return (
            <div className="character-area">
                {/* 캐릭터 이미지를 숨기고 텍스트 상태만 노출 */}
                <div className="character-area-control-area">
                    {nameArea}
                    <div className="character-area-control">
                        <div className="character-area-control-title">STATUS</div>
                        <div className="character-area-control-field">
                            <div className="character-area-text">vol: <span id="status-vol">0</span></div>
                            <div className="character-area-text">buf: <span id="status-buf">0</span> ms</div>
                            <div className="character-area-text">res: <span id="status-res">0</span> ms</div>
                        </div>
                    </div>
                    {startControl}
                    {gainControl}
